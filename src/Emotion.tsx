...
export const EMOTION_SYNONYMS: {[key in Emotion]: string[]} = {
    ...
    annoyance: ['annoyed', 'irritated', 'irritation', 'frustrated', 'frustration', 'exasperated', 'exasperation', 'vexed', 'aggravated', 'aggravation', 'peeved', 'miffed', 'irked'],
    ...
    caring: ['compassionate', 'compassion', 'kindness', 'kind', 'considerate', 'consideration', 'sympathy', 'sympathetic', 'empathy', 'empathetic', 'tender', 'tenderness', 'gentle', 'nurturing', 'supportive'],
    ...
    love: ['loving', 'lovestruck', 'adoration', 'adoring', 'devotion', 'devoted', 'infatuated', 'infatuation', 'romantic', 'romance', 'affection', 'affectionate', 'enamored', 'fond', 'fondness', 'passionate', 'passion'],
